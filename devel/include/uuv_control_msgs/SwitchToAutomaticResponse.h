...
bool operator==(const ::uuv_control_msgs::SwitchToAutomaticResponse_<ContainerAllocator1> & lhs, const ::uuv_control_msgs::SwitchToAutomaticResponse_<ContainerAllocator2> & rhs)
{
