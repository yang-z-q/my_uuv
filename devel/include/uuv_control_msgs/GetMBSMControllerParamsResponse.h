...
bool operator==(const ::uuv_control_msgs::GetMBSMControllerParamsResponse_<ContainerAllocator1> & lhs, const ::uuv_control_msgs::GetMBSMControllerParamsResponse_<ContainerAllocator2> & rhs)
{
