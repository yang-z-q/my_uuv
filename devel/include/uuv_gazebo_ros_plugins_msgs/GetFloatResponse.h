...
bool operator==(const ::uuv_gazebo_ros_plugins_msgs::GetFloatResponse_<ContainerAllocator1> & lhs, const ::uuv_gazebo_ros_plugins_msgs::GetFloatResponse_<ContainerAllocator2> & rhs)
{
