...
bool operator==(const ::uuv_world_ros_plugins_msgs::SetCurrentModelRequest_<ContainerAllocator1> & lhs, const ::uuv_world_ros_plugins_msgs::SetCurrentModelRequest_<ContainerAllocator2> & rhs)
{
