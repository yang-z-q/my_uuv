...
bool operator==(const ::uuv_world_ros_plugins_msgs::TransformFromSphericalCoordRequest_<ContainerAllocator1> & lhs, const ::uuv_world_ros_plugins_msgs::TransformFromSphericalCoordRequest_<ContainerAllocator2> & rhs)
{
