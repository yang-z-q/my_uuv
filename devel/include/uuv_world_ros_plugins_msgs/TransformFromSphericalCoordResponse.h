...
bool operator==(const ::uuv_world_ros_plugins_msgs::TransformFromSphericalCoordResponse_<ContainerAllocator1> & lhs, const ::uuv_world_ros_plugins_msgs::TransformFromSphericalCoordResponse_<ContainerAllocator2> & rhs)
{
