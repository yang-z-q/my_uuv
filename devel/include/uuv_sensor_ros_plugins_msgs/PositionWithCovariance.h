...
bool operator==(const ::uuv_sensor_ros_plugins_msgs::PositionWithCovariance_<ContainerAllocator1> & lhs, const ::uuv_sensor_ros_plugins_msgs::PositionWithCovariance_<ContainerAllocator2> & rhs)
{
