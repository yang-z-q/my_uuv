...
class PhinsStandard {
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.algorithm_status_lsb);
    length += _getByteLength(object.algorithm_status_msb);
    length += _getByteLength(object.system_status_lsb);
    length += _getByteLength(object.system_status_msb);
    length += _getByteLength(object.user_status);
    return length + 222;
  }
