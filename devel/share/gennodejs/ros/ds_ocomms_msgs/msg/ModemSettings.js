...
class ModemSettings {
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.ip_addr);
    length += _getByteLength(object.netmask);
    length += _getByteLength(object.brdcst);
    length += _getByteLength(object.dfltgw);
    length += _getByteLength(object.dfltip);
    length += _getByteLength(object.dflmac);
    length += _getByteLength(object.laripa);
    length += _getByteLength(object.larmac);
    length += _getByteLength(object.lfpipa);
    length += _getByteLength(object.lfpmac);
    length += _getByteLength(object.remipa);
    length += _getByteLength(object.raripa);
    length += _getByteLength(object.rarmac);
    length += _getByteLength(object.rsubnt);
    length += _getByteLength(object.brdgip);
    length += _getByteLength(object.guiipa);
    length += _getByteLength(object.fpg3vr);
    length += _getByteLength(object.fpg6vr);
    length += _getByteLength(object.softvr);
    return length + 150;
  }
