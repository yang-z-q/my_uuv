...
echo_and_run cd "/home/yang/my_uuv/src/uuv_simulator/uuv_control/uuv_control_cascaded_pids"
...
echo_and_run /usr/bin/env \
    ...
    "/home/yang/my_uuv/src/uuv_simulator/uuv_control/uuv_control_cascaded_pids/setup.py" \
     \
    build --build-base "/home/yang/my_uuv/build/uuv_simulator/uuv_control/uuv_control_cascaded_pids" \
    install \
    --root="${DESTDIR-/}" \
