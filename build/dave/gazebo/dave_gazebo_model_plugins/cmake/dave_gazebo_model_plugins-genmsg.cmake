...
set(MSG_I_FLAGS "-Idave_gazebo_model_plugins:/home/yang/my_uuv/src/dave/gazebo/dave_gazebo_model_plugins/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/yang/my_uuv/src/dave/gazebo/dave_gazebo_model_plugins/msg/UsblCommand.msg" NAME_WE)
add_custom_target(_dave_gazebo_model_plugins_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "dave_gazebo_model_plugins" "/home/yang/my_uuv/src/dave/gazebo/dave_gazebo_model_plugins/msg/UsblCommand.msg" ""
)

get_filename_component(_filename "/home/yang/my_uuv/src/dave/gazebo/dave_gazebo_model_plugins/msg/UsblResponse.msg" NAME_WE)
add_custom_target(_dave_gazebo_model_plugins_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "dave_gazebo_model_plugins" "/home/yang/my_uuv/src/dave/gazebo/dave_gazebo_model_plugins/msg/UsblResponse.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dave_gazebo_model_plugins)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dave_gazebo_model_plugins\")")
  # install generated code
  install(
